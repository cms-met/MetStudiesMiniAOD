#ifndef scale_gamma_h
#define scale_gamma_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   scale_gamma(const char* file1, const char* file2);
   virtual ~scale_gamma();
...
#ifdef scale_gamma_cxx
scale_gamma::scale_gamma(const char* file1, const char* file2) 
{
   BookHistos(file2);
...
Int_t scale_gamma::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t scale_gamma::LoadTree(Long64_t entry)
{
...
void scale_gamma::Init(TTree *tree)
{
...
void scale_gamma::Show(Long64_t entry)
{
...
Int_t scale_gamma::Cut(Long64_t entry)
{
