...
std::pair<double,double> METXYCorr_Met_MetPhi(double uncormet, double uncormet_phi, int runnb, int year, bool isMC, int npv, bool metxy){

  std::pair<double,double>  TheXYCorr_Met_MetPhi(uncormet,uncormet_phi);
  std::pair<double,double>  TheXYCorr_Metx_Mety(uncormet,uncormet_phi);
  ...
  TheXYCorr_Metx_Mety.first= CorrectedMET_x;
  TheXYCorr_Metx_Mety.second= CorrectedMET_y;
  if(metxy) return TheXYCorr_Metx_Mety;
  return TheXYCorr_Met_MetPhi;
}
