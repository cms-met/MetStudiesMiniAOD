{
  ...
  f1.open("uperp_reso_data_2018A.txt");
  f2.open("uperp_reso_data_2018B.txt");
  f3.open("uperp_reso_data_2018C.txt");
  f4.open("uperp_reso_data_2018D.txt");
  string s1;
  float yvalue1, yerr1;
  Float_t bins[] = { 50, 60, 80, 90, 100, 110, 130, 140, 160, 180, 200, 240, 320, 400, 500 };
  Int_t  binnum = 14;
